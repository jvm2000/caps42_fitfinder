        ...
        <div class="h-full w-full overflow-y-auto relative">
            ...
            <div class="w-full h-auto py-20 grid place-items-center" id="about">
                <div class="flex place-items-center space-x-32">
                    ...
                    <div class="grid space-y-6">
                        ...
                        <p class="text-base text-gray-800 font-normal">Elevate your training experience with our advanced matchmaking<br> platform, connecting trainees with expert coaches who will guide<br> and empower them to achieve their fitness goals.</p>
                        <div class="flex place-items-center space-x-10">
                            ...
                            <div class="w-[30rem] h-auto space-y-4">
                                ...
                                <p class="text-base text-gray-600 font-normal">FitFinder helps users easily match with their preferred coach or trainee.</p>
                            </div>
                        </div>
                        <div class="flex place-items-center space-x-10">
                            ...
                            <div class="w-[30rem] h-auto space-y-4">
                                ...
                                <p class="text-base text-gray-600 font-normal">FitFinder strives to provide an exceptional platform for coaches and trainees to connect seamlessly.</p>
                            </div>
                        </div>
                        <div class="flex place-items-center space-x-10">
                            ...
                            <div class="w-[30rem] h-auto space-y-4">
                                ...
                                <p class="text-base text-gray-600 font-normal">FitFinder offers a user-friendly platform, ensuring a seamless and enjoyable experience for all users.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full h-auto pt-20 pb-96 grid place-items-center" id="features">
                <div class="w-full grid place-items-center">
                    ...
                    <p class="mt-10 text-center text-lg font-normal">Fitfinder provides a comprehensive set of features, allowing users to effortlessly find coaches or <br>trainees, view detailed profiles, set up contracts, access coach modules, track trainee progress, and<br> engage in real-time online teaching.</p>
                <div class="pt-32 grid grid-cols-3 gap-36">
                    ...
                    >
                        <div class="top-4 absolute text-xl font-bold w-[12.5rem] text-center">FIND A COACH OR TRAINEE</div>
                    ...
                    <div 
                        class="w-[297px] h-[268px] grid place-items-center relative bg-gradient-to-b from-cyan-300 to white rounded-xl "
                    >
                        <div class="top-4 absolute text-xl font-bold w-[12.5rem] text-center">VIEW COACH OR TRAINEE PROFILE</div>
                    ...
                    <div 
                        class="w-[297px] h-[268px] grid place-items-center relative bg-gradient-to-b from-cyan-300 to white rounded-xl "
                    >
                        <div class="top-4 absolute text-xl font-bold w-[12.5rem] text-center">PROVIDE COACH MODULES</div>
                    ...
                    <div 
                        class="w-[297px] h-[268px] grid place-items-center relative bg-gradient-to-b from-cyan-300 to white rounded-xl "
                    >
                        <div class="top-4 absolute text-xl font-bold w-[12.5rem] text-center">MANAGE TRAINEES PROGREES</div>
                    ...
                    <div 
                        class="w-[297px] h-[268px] grid place-items-center relative bg-gradient-to-b from-cyan-300 to white rounded-xl "
                    >
                        <div class="top-4 absolute text-xl font-bold w-[12.5rem] text-center">REALTIME ONLINE COACHING</div>
