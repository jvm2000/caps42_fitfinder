																	...
																	<div class="flex items-center space-x-4">
																			<div class="w-6 h-6 rounded-full relative">
																					<img class="w-full h-full rounded-full"
																							src="{{ $program->getImageURL() }}" alt="">
																			</div>
																			<p class="text-lg font-medium">{{ $program->name }}</p>
																	</div>
																	<div
																			class="px-2 py-0 rounded-full
																			@if ($program->prerequisite) bg-indigo-200 border border-dashed border-indigo-800 text-indigo-800
																			@else
																			bg-red-200 border border-dashed border-red-800 text-red-800 @endif
																			text-xs">
